...
export const projects = [
  ...
  { id: 5, title: "AI Study Buddy", description: "An AI-powered chatbot that helps students with doubt resolution and study material recommendations.", team: ["Arjun Mehta", "Simran Kaur"], status: "In Progress" as const, tech: ["Python", "LLM", "React"], club: "Coding Club", progress: 55 },
  { id: 6, title: "Campus Food Ordering App", description: "Online food ordering system for all campus canteens with real-time order tracking.", team: ["Karan Joshi", "Neha Patel"], status: "Completed" as const, tech: ["React", "Firebase", "Stripe"], club: "Coding Club", progress: 100 },
  { id: 7, title: "Virtual Lab Simulator", description: "3D simulation environment for physics and chemistry lab experiments.", team: ["Ananya Gupta", "Rahul Kumar", "Priya Sharma"], status: "In Progress" as const, tech: ["Three.js", "WebGL", "React"], club: "Robotics Lab", progress: 30 },
  { id: 8, title: "Alumni Connect Platform", description: "Networking platform connecting current students with alumni for mentorship and career guidance.", team: ["Vikram Singh", "Priya Sharma"], status: "Planning" as const, tech: ["Next.js", "PostgreSQL"], club: "E-Cell", progress: 10 },
  { id: 9, title: "Campus Safety Alert System", description: "Real-time emergency alert and SOS system with GPS tracking for student safety.", team: ["Rahul Kumar", "Karan Joshi"], status: "In Progress" as const, tech: ["React Native", "Node.js", "WebSocket"], club: "Coding Club", progress: 75 },
  { id: 10, title: "Digital Notice Board", description: "Smart digital notice board displaying announcements, timetables, and event updates across campus.", team: ["Simran Kaur", "Neha Patel"], status: "Completed" as const, tech: ["React", "Raspberry Pi", "MQTT"], club: "Robotics Lab", progress: 100 },
];
